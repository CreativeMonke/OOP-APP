# Scope: Implementation of R2, R3, R4, and E2E verification
...
- Popout editor window is routed to `PopoutEditorPage.tsx`.

## Milestones
| # | Name | Scope | Dependencies | Status |
|---|------|-------|-------------|--------|
| A | R1: Pop-out Window | Fix pop-out editor window routing, blank screen, translucency, backdrop blur, title/close window controls, Tauri capabilities. | none | DONE |
...
## Interface Contracts
- HashRouter is used for routing: path format `index.html#/popout?id=<id>` for pop-out.
- Pop-out window communication: the popup fetches the exercise by ID and uses Monaco editor.
